...
ggplot()+
  ...
  labs(
    ...
    subtitle = "Theoretical quantiles from a Chi-Squared 
with P = 4 degrees of freedom (QCP) 
...
print(paste("Proportion of points where D^2 < critical value", mean(d2 < critical)*100))
